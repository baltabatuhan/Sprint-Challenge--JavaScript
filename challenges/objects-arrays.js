...
console.log(dinosaursA.weight);

// What was the diet of a velociraptor?
console.log(dinosaursC.diet);

// How long was a stegosaurus?
console.log(dinosaursB.lenght);

// What time period did tyrannosaurus live in?
console.log(dinosaursA.period);

// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
dinosaursA.roar = function() {
  return "RAWERSRARARWERSARARARRRR!";
};

console.log(dinosaursA.roar());
...
const contactInfo = [];
for (let a = 0; a < graduates.length; a++) {
  contactInfo.push(graduates[a].first_name + " " + graduates[a].email);
}
...
for (let b = 0; b < graduates.length; b++) {
  if (graduates[b].university.includes("Uni")) {
    unisWithUni.push(graduates[b].university);
  }
}
